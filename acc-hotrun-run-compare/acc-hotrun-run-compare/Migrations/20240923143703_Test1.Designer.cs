...
namespace acc_hotrun_run_compare.acchotrunruncompare.Migrations
{
    ...
    [Migration("20240923143703_Test1")]
    partial class Test1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("acc_hotrun_run_compare.DBClasses.RunInformation", b =>
                {
            ...
            modelBuilder.Entity("acc_hotrun_run_compare.DBClasses.SectorInformation", b =>
                {
                    b.Property<long>("RunID")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("acc_hotrun_run_compare.DBClasses.SectorInformation", b =>
                {
                    b.HasOne("acc_hotrun_run_compare.DBClasses.RunInformation", null)
                        .WithMany("SectorList")
                        .HasForeignKey("RunID")
